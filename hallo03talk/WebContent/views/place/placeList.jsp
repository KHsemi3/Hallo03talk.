<%@page import="java.util.ArrayList"%> <%@page import="com.h3.placePhoto.vo.PlacePhotoVo"%> <%@page
import="com.h3.place.vo.PlaceVo"%> <%@page import="java.util.List"%> <%@ page language="java" contentType="text/html;
charset=UTF-8" pageEncoding="UTF-8"%> <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%> <%@taglib prefix="fn"
              ...
              <div class="col mb-5">
                <div class="card" style="width: 350px">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <a href="/hallo03talk/place/one?placeNo=${ p.no }" class="btn btn-primary col-5 ms-3">더보기</a>
                      <div class="col"></div>
                      ...
                      <div class="d-flex col align-items-center">
                        <c:if test="${ travelerLoginMember != null }">
                          <a href="/hallo03talk/zzim/add" class="zimmBtn">
                            <svg
