...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    ReportUserVo vo = (ReportUserVo)request.getAttribute("vo");
...
<body>
			...
			<main>
					<div id="container" class="container-xxl">
						<ul>
	<li id="reportImg"><img src="<%=request.getContextPath()%>/resources/img/report.png" alt="" /> 신고 유저 관리</li>
</ul>	
<hr />
        ...
        <div class="content_wrap">
            ...
            <div class="bt_wrap">
                <a onclick="location.href='/hallo03talk/admin/reportUser?p=1'" href="#" class="on">목록으로 돌아가기</a>
