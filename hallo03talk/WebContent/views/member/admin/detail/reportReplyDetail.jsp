...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    ReportCommentVo vo = (ReportCommentVo)request.getAttribute("vo");
...
<body>
			...
			<main>
					<div id="container" class="container-xxl">
						...
						<ul>
	<li id="reportImg"><img src="<%=request.getContextPath()%>/resources/img/report.png" alt="" /> 신고 댓글 관리</li>
</ul>	
<hr />
        ...
        <div class="content_wrap">
            ...
            <div class="bt_wrap">
                <a onclick="location.href='/hallo03talk/admin/reportReply'" href="#" class="on">목록으로 돌아가기</a>
