	...
	<main>
		<div id="container" class="container-xxl">
			...
			<div id="container-header">
				...
				<button class="btn btn-outline-warning chi">글쓰기</button>
			</div>
			<hr>
			...
			<div id="contents">
				...
				<!-- 이게 하나 -->
				<div id="content-items" class="d-flex" onclick="//상세페이지 접근 함수"> <!-- 상세페이지 접근 함수 -->
					...
					<div id="content-items-title">
						<h5>제주도 서귀포쪽 같이 돌아디닐 분 구해요!</h5>
						<p>#tag#tag#tag#tag</p>
						<div class="d-flex align-items-center">
							<img src="/hallo03talk/resources/img/with/with_detail_cal.svg" width="16px" height="16px" class="me-1"> <span>22-08-06 ~ 22-08-16</span>
						</div>
					</div>
					<div class="d-flex align-items-center flex-shrink-0">
						...
						<span>5</span> <img src="/hallo03talk/resources/img/with/with_board_defaultMan.png" width="24px" height="24px"> <span>chan0966</span> <span class="rounded bg-warning align-self-center p-1" id="mojip">모집중</span>
						<!-- <span class="rounded " id="magam">마감됨</span> -->
						<span class="text-black-50">22-08-06 12:12</span>
					</div>
				</div>
				<hr>
				<!-- 여기까지 -->
