		...
		<div id="container" class="container-xxl">
			...
			<div id="contents">
				...
				<div id="content-items" class="d-flex" onclick="//상세페이지 접근 함수"> <!-- 상세페이지 접근 함수 -->
					<img
						src="/hallo03talk/resources/img/with/with_board_defaultimg.jpg"
						class="rounded" height="100" width="150">
					<div id="content-items-title">
						<h5>제주도 서귀포쪽 같이 돌아디닐 분 구해요!</h5>
						<p>#tag#tag#tag#tag</p>
						<div class="d-flex align-items-center">
							<img src="/hallo03talk/resources/img/with/with_detail_cal.svg"
								width="16px" height="16px" class="me-1"> <span>22-08-06
								~ 22-08-16</span>
						</div>
					</div>
              ...
              <path
						...
						<span>5</span> <img
							...
							width="24px" height="24px"> <span>chan0966</span> <span
							class="rounded " id="mojip">모집중</span>
