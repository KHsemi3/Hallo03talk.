...
//	장소 사진 추가
	public int placePhotoAdd(Connection conn, ArrayList<PlacePhotoVo> photoVoList) {
		...
		String sql = "INSERT INTO PLACE_PHOTO(NO,NAME,PATH,PLACE_NO,PROFILE) VALUES(SEQ_PLACE_PHOTO_NO.NEXTVAL,?,?,SEQ_PLACE_NO.CURRVAL,?)";
...
//	목록 총 개수
	...
	public List<PlacePhotoVo> getProfile(Connection conn) {
		...
		String sql = "SELECT(H.NO,H.NAME,H.PATH,H.ENROLL_DATE,H.PLACE_NO) FROM PLACE_PHOTO H JOIN PLACE P ON P.NO = H.PLACE_NO WHERE H.STATUS='Y' AND H.PROFILE='Y'";
